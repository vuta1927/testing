...
namespace DAL
{
    class MapContextSeed : IDbContextSeed
    {
        private readonly ILogger<MapContextSeed> _logger;
        private readonly MapContext _ctx;
        public MapContextSeed(ILogger<MapContextSeed> logger, MapContext context)
        {
            _logger = logger;
            _ctx = context;
        }

        public Type ContextType => typeof(MapContext);
        public async Task SeedAsync()
        {
            var policy = CreatePolicy(nameof(MapContext));
